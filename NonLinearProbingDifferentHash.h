...
#ifndef P5_NONLINEARPROBINGDIFFERENTHASH_H
#define P5_NONLINEARPROBINGDIFFERENTHASH_H
...
class NonLinearProbingDifferentHash {
private:
...
public:
    // Constructor
    NonLinearProbingDifferentHash(unsigned long tableSize, function<string(Hashable)> getKey) {
...
#endif //P5_NONLINEARPROBINGDIFFERENTHASH_H
